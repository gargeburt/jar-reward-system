...
| 23 | 孩子免登录查看 | 孩子可在设备上直接打开查看当前两罐积分，无需登录；仅在执行提现时需登录身份验证 |
| 24 | 补录历史数据 | 家长管理页支持为某一缺失日期补录任务记录，系统会把补录的 +1/-1 作用到当前余额并写流水 |
...
备注：孩子可以直接在手机或平板上打开首页查看当前积分（匿名查看家庭第一个孩子），当需要提现时必须使用孩子账号登录以完成提现流程。
